...
import { User, Bell, Lock, SettingsIcon, Save, Eye, EyeOff } from "lucide-react"
            ...
            <Card className="bg-white border-gray-200 shadow-sm">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-[#F7F6FE] rounded-lg border border-gray-200">
                    <div>
                      <h3 className="text-[#121212] font-medium">Auto Backup</h3>
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#F7F6FE] rounded-lg border border-gray-200">
                    <div>
                      <h3 className="text-[#121212] font-medium">Maintenance Mode</h3>
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#F7F6FE] rounded-lg border border-gray-200">
                    <div>
                      <h3 className="text-[#121212] font-medium">Debug Mode</h3>
                      <p className="text-gray-600 text-sm">Enable debug logging for troubleshooting</p>
                    </div>
                    <Button variant="outline" size="sm">
                      Disabled
                    </Button>
                ...
                <div className="space-y-4">
                  <h3 className="text-[#121212] font-medium">Danger Zone</h3>
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="text-red-600 font-medium">Reset System</h4>
                        <p className="text-red-500 text-sm">This will reset all system settings to default</p>
                      </div>
